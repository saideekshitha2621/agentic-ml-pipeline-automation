...
# least one of these four (see backend/.env) to enable that provider.
#
...
# for PROVIDER in ANTHROPIC / OPENAI / GEMINI / GROQ. All variants found are pooled together
# and deduplicated — see app/services/llm_key_manager.py for the health-tracking/failover
